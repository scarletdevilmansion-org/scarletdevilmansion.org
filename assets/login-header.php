...
<html lang="TR" style="font-family: 'Comic Sans MS', 'Comic Sans', cursive;">
    ...
    <body>
        ...
        <!--<div class="navbar">
            ...
            <a href="http://localhost/pages/u/<?php /* echo $_SESSION['username'] ?>/">
                <span class="text nav-text">
                    <img src="http://localhost/pages/u/<?php echo $_SESSION['username'] */?>/user-pictures/logo.png" class="img-size" title="Profil">
                </span>
            </a>
        ...
        <nav class="sidebar close">
            ...
            <header>
                <div class="image-text">
                    <a class="image" href="http://localhost/pages/u/<?php echo $_SESSION['username'] ?>/">
                        <img src="http://localhost/pages/u/<?php echo $_SESSION['username'] ?>/user-pictures/logo.png" alt="Profil Resmi">
                    </a>
    
                    <div class="text logo-text">
                        <span class="name">Scarlet Devil Mansion</span>
                        <span class="profession"><?php echo $_SESSION['username']; ?></span>
                    </div>
                </div>
            ...
            <div class="menu-bar">
                ...
                <div class="bottom-content">
                    <li class="">
                        <a href="http://localhost/functions/logout/">
