...
$email = 'sc4rlet.remilia@gmail.com';
$name = 'Kaan';
$recovery_code = "243242";
...
$mail->Username = 'support@scarletdevilmansion.org';    // SMTP username
...
echo "Message hasn't been sent: {$mail->ErrorInfo}";
?>