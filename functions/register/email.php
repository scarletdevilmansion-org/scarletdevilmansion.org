              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Değerli kullanıcımız <?php echo $name; ?>,</p>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <?php echo '<a href="https://scarletdevilmansion.org/verification/?username=' . $username . '&uvid=' . $vuid . '" target="_blank">Hesabını Doğrula</a>'; ?> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block powered-by">
                    Yapmaya üşenildiği için e-posta şablonu <a href="http://htmlemail.io" style="color: #ccc61f;">buradan</a> alınmıştır.
                  </td>
                </tr>
              </table>
            </div>
