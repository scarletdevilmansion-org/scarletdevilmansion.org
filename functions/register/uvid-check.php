...
require "../../functions/uvid-func.php";
...
$user_verify_code = "INSERT INTO `user_verification` (`username`, `uvid`) VALUES ('$username', '$uvid')";
mysqli_query($db, $user_verify_code);
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="https://localhost/functions/verification/?username=' . $username . '&uvid=' . $uvid . '" target="_blank">Hesabını Doğrula</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
